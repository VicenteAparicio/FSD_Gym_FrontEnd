        ...
        <section id="forMe" className="sections">
            ...
            <div id="bottomBanner">
                ...
                <div className="centerBanner" style={{backgroundImage: `url(${Centerbanner})`}}>
                    <div id="bannerLogotype" className="logoArea">
